...
class JSONLDataLoggerDiffusion:
    ...
    def append_data(self, obs_ee, obs_dlo, obs_target, action, idx, action_from_grasp_to_release):
    ...
    def update_action_data(self, obs_target, idx, action_from_grasp_to_release):
...
class JSONLDataLoggerSimpleFC:
    ...
    def save_data(self, initial_shape, final_shape, action):
        """Append observation and action to file"""
