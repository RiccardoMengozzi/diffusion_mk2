...
filename  = os.path.join(project_dir, "json_data", "test_simplified.jsonl")
zarr_filename = os.path.join(project_dir, "zarr_data/shape_prediction_simplified.zarr.zip")
