...
filename  = os.path.join(project_dir, "json_data", "combined_dataset_cleaned_short.jsonl")
zarr_filename = os.path.join(project_dir, "zarr_data/dataset_cleaned_short.zarr.zip")
