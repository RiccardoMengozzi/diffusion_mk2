...
filename  = os.path.join(project_dir, "json_data", "combined_dataset_test_first.jsonl")
zarr_filename = os.path.join(project_dir, "zarr_data/pushing_dataset_test_first.zarr.zip")
